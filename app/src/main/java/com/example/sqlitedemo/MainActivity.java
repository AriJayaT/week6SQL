        ...
        builder.setPositiveButton(
                ...
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(
                        ...
                        // only update list if insert succeeded and we can load the contact
                        if (newID > 0) {
                            Contact added = db.getContact(newID);
                            if (added != null) {
                                contacts.add(added);
        ...
        builder.setPositiveButton(
                ...
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(
                        ...
                        Contact updatedContact = new Contact(editContact.getID(), nameInput, phoneInput);
                        contacts.set(position, updatedContact);
                        adapter.notifyItemChanged(position);
                        //edit contact in sqlite database (use same object, no need to fetch from DB)
